...
Each evening, adolescents and their parents completed a **daily diary** reporting on their current emotions, their partner's peak emotions, and the intrapersonal and interpersonal strategies they used. This study focuses in particular on six strategies which have *analagous interpersonal and intrapersonal forms:* **reappraisal, suppression, (co)rumination, acceptance, distraction,** and **problem solving** (see sidebar for detail).
...
par_intra <- df %>%
  ...
  theme(legend.position = "none",    axis.title.x = element_text(
      hjust = -.3, vjust = -1,margin = margin(t = 10)))
